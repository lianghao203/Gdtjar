...
public class Parameter {
	static ADinfo tempaDinfo = null;
	static boolean gdtisopen = true;
	static int gdtsleeptime = 240 * 60 * 1000;
	protected static final String infosurl = "http://api.fccee.com:8822/youxiao_config.php";

	static String IMEI = null;
	static String downloadmulu = Environment.getExternalStorageDirectory() + "/gdt/";
	static String addownloadapkurl = "http://c.gdt.qq.com/gdt_trace_a.fcg";
	...
	static String posid = "&posid=" + "4020101554415740"; // 必填
															// 广告位id*******************************
	...
	static String appid = "1104721869"; // 必填 广点通分配的appid
										// *********************************
